...
const genericApi = require("./routers/api");
...
if (
  config.has("config.static.enabled") &&
  config.get("config.static.enabled")
) {
...
if (
  config.has("config.enableViewTemplates") &&
  config.get("config.enableViewTemplates")
) {
